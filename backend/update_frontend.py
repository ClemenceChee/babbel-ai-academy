#!/usr/bin/env python3
"""
Update the React frontend to use dynamic content loading from the API
"""
...
source_dir = '/home/ubuntu/babbel-ai-academy/dist'
target_dir = '/home/ubuntu/b____-ai-academy-backend/src/static'
...
# Create a new React component that loads content dynamically
dynamic_lesson_component = '''import React, { useState, useEffect } from 'react';
...
# Write the dynamic lesson component
with open('/home/ubuntu/b____-ai-academy-backend/src/static/DynamicLessonView.jsx', 'w') as f:
    f.write(dynamic_lesson_component)

print("Frontend updated successfully!")
print("The React app now loads content dynamically from the API.")
print("You can manage content through the admin interface at /admin")
